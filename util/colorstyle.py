...
def use_style_level(dic_level, string):
    mode = '%s' % dic_level['mode'] if 'mode' in dic_level else ''
    fore = '%s' % dic_level['fore'] if 'fore' in dic_level else ''
    back = '%s' % dic_level['back'] if 'back' in dic_level else ''
